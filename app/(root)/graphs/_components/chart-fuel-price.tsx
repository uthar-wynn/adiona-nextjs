...
export const ChartFuelPrice = ({ data }: { data: GraphDataType }) => {
    const { fillups } = data
...
const CustomTooltip = ({ active, payload }: any) => {
    ...
    return (
        <div className="flex flex-col min-w-[300px] rounded border-collapse bg-background p-4">
            ...
            <TooltipRow label="Prijs per liter" value={unit_price} bgColor="bg-green-500" textColor="text-green-500" />
        </div>
    )
}
